...
|---|---|:---:|:---:|:---:|---|
| [task-00](./task-00-restructure.md) — Restructure: feature folders, go_router, Riverpod, persistence | — | M (5 steps) | 0 | task-01 | not started |
| [task-01](./task-01-remove-reverso.md) — Reverso is gone from the app and the Worker | 1 | S | 1 | — | code complete (`8a6356f`); device ACs pending |
| [task-02](./task-02-word-limit-is-a-cap.md) — The word limit is a cap, not a quota | 2 | S | 2 | — (D2 resolved: reading order) | not started |
| [task-03](./task-03-words-survive-restart.md) — Collected words survive an app restart | 3 | M | 2 | — | covered by task-00 step 3; keep its device ACs |
...
wave 2:  02  ∥  03     (03 is task-00 step 3; only its device ACs remain)
wave 3:  04  ∥  05  ∥  08
wave 4:  06
wave 5:  07
```
...
| | Command | Notes |
|---|---|---|
| Flutter app | `flutter analyze` · `flutter test` | `test/` holds exactly one test today, and it is a **live-network** smoke test, not CI-safe |
